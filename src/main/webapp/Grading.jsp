    ...
    try {
        ...
        for (String clasx: classes) {
            if (clasx.length() >= 2) {
                ...
                writer.println("<a href= \"CalFinal.jsp?clasx=" + clasx + "\" style=\"width: 80px;\"><button class=\"btn btn-primary\" style=\"width: 100px; margin-top: 20px;\" type=\"button\">Update Semester Score</button></a>\n");
