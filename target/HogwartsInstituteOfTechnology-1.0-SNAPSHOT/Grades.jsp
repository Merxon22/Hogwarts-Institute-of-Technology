...
<%
    ...
    try {
        ...
        writer.println("<h2 style=\"padding-bottom: 20px; margin-bottom: 20px; border-bottom: 1px solid darkgrey\"><b>Choose the class you want to modify/view grade</b></h2>\n");
        writer.println("<h4><b>Subjects</b></h4>");
        writer.println("<div class=\"list-group\">");
        for (int i = 0; i < classes.length; i++) {
            if (classes[i].length() >= 2){
                String claa = classes[i];
                writer.println("<a href=\"Grading2.jsp?clasx=" + claa + "\" class=\"list-group-item list-group-item-action\" style=\"width: 40%; display: flex; justify-content: center; align-items: center; margin-left: auto; margin-right: auto\">");
